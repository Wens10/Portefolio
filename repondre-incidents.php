...
<head>
    ...
    <title>BTS SIO - Répondre aux incidents et aux demandes d’assistance et d’évolution</title>
    <meta name="description" content="Portfolio des compétences - Bloc 2 : Répondre aux incidents et aux demandes d’assistance et d’évolution">
...
<body>
    ...
    <section>
        <h1>Bloc 2 - Répondre aux incidents et aux demandes d’assistance et d’évolution</h1>
        <ul>
            <li><a href="#c1"><button>Compétence 1 - Collecter, suivre et orienter des demandes</button></a></li>
            <li><a href="#c2"><button>Compétence 2 - Traiter des demandes concernant les services réseau et système, applicatifs</button></a></li>
            <li><a href="#c3"><button>Compétence 3 - Traiter des demandes concernant les applications</button></a></li>
        </ul>
        <hr>
        <article id="c1">
