...
<head>
    ...
    <title>BTS SIO - Gérer le patrimoine informatique</title>
    <meta name="description" content="Portfolio des compétences - Bloc 1 : Gérer le patrimoine informatique">
...
<body>
    ...
    <!--Changer l'url par celui de votre site-->
    <a href="http://www.linkedin.com/shareArticle?mini=true&url=https://fredericeducentre.github.io/exemple_section_portfolio_bts_sio/"><button>Partager sur LinkedIn</button></a>
    <section>
        <h1>Bloc 1 - Gérer le patrimoine informatique</h1>
        <ul>
            <li><a href="#c1"><button>Compétence 1 - Recenser et identifier les ressources numériques</button></a> </li>
            <li><a href="#c2"><button>Compétence 2 - Exploiter des référentiels, normes et standards adoptés par le prestataire informatique</button></a> </li>
            <li><a href="#c3"><button>Compétence 3 - Mettre en place et vérifier les niveaux d’habilitation associés à un service</button></a> </li>
            <li><a href="#c4"><button>Compétence 4 - Vérifier les conditions de la continuité d’un service informatique</button></a> </li>
            <li><a href="#c5"><button>Compétence 5 - Gérer des sauvegardes</button></a> </li>
            <li><a href="#c6"><button>Compétence 6 - Vérifier le respect des règles d’utilisation des ressources numériques</button></a> </li>
        </ul>
        <hr>
        <article id="c1">
            <h2>Compétence 1 - Recenser et identifier les ressources numériques</h2>
            <div>
                <a href="#c1-formation">
            ...
            <div id="c1-tutoriel">
                ...
                <p>Dans cette vidéo, je montre comment recenser un parc informatique avec GLPI.</p>
                <iframe width="550" height="500" src="https://www.youtube.com/embed/whRh1HTCt4s?si=V6WJpK244HGq_mpP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </article>
        <hr>
        <article id="c2">
