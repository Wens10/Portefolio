  ...
  <div class="footer-inner">
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        <a href="index.php" class="footer-brand-name">Wenceslas BOUITY</a>
        <p>Développeur Web & Logiciel passionné, basé à Paris. Ouvert aux opportunités d'alternance et de stage.</p>
        ...
        <div class="footer-social">
          <a href="https://www.linkedin.com/in/wenceslas-jude-bouity-905430331/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <img src="assets/images/linkedin-svgrepo-com (1).svg" alt="LinkedIn" width="16" height="16">
          </a>
          <a href="https://github.com/Wens10" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            <img src="assets/images/github (1).svg" alt="GitHub" width="16" height="16">
          </a>
          <a href="https://www.instagram.com/mr_wenss/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <img src="assets/images/instagram-circle.svg" alt="Instagram" width="16" height="16">
          </a>
        </div>
      </div>
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="index.php#about">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg>
            Parcours
          </a></li>
          <li><a href="projets.php">
      ...
      <div class="footer-col">
        <h4>Contact</h4>
        <ul>
          <li><a href="mailto:wenceslasbouity92@gmail.com">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
            wenceslasbouity92@gmail.com
          </a></li>
          <li><a href="https://github.com/Wens10" target="_blank" rel="noopener noreferrer">
          ...
          <li><a href="https://www.linkedin.com/in/wenceslas-jude-bouity-905430331/" target="_blank" rel="noopener noreferrer">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
            LinkedIn
          </a></li>
          <li><a href="assets/images/Mon%20CV.pdf" download>
    ...
    <div class="footer-bottom">
      <p>&copy; <?= date('Y'); ?> Wenceslas BOUITY &mdash; Tous droits réservés</p>
