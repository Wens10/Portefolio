<article class="resumeArticle" >
                <div id="line"></div>
                <div class="veryBigestContainer">
                    <div class="bigResumeContainer">
                        <div class="resumeContainer">
                            <div class="companyContainer">
                                <div class="company">
                                    <div class="pictureContainer">
                                        <div class="digitalInsure"></div>
                                    </div>
...
Ils conçoivent, programment et maintiennent des solutions logicielles pour les entreprises.</p>
                                        
                                    </div>
                                </div>
                            </div>
                            <div class="check"></div>
                            <div class="resumeDate">2024-2026</div>
                        </div>
                    </div>
                    <div class="veryBigContainer">
                        <div class="bigResumeContainer">
                            <div class="resumeContainer">
                                <div class="resumeDateLeft">2022 - 2024</div>
                                <div class="check"></div>
                    ...
                    <div class="bigResumeContainer">
                        <div class="resumeContainer">
                            ...
                            <div class="check"></div>
                            <div class="resumeDate">2021 - 2022</div>
                        </div>
                    </div>
                </div>
            </article>